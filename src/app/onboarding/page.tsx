          ...
          {stage === "set_number" ? (
            <>
              <h2 className="text-xl sm:text-2xl font-bold text-black">
                Step 1: Sign up with your phone
              </h2>
              <p className="text-sm text-gray-500 mt-4">
                Budgetize works through texting you. Enter your phone number to
                get started.
              </p>
              <form className="mt-6 space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full text-white bg-black py-2 rounded-lg text-sm font-semibold"
                  onClick={() => {
                    alert("Create account in the DB");
                  }}
                >
                  Sign up
                </button>
            ...
            <>
              ...
              <p className="text-sm text-gray-500 mt-4">
                Now lets come up with some budget buckets. You can always add
                more later!
              </p>
